            ...
            >
                <ul className="space-y-4 pb-6">
                    {allLanguages.map(language => {
                        if (
                            language.name.toLowerCase().indexOf(searchValue) >
                            -1
                        ) {
                            return (
                                <LanguageRow
            ...
            >
                <div className="flex justify-between items-center shadow-md py-1 px-3 rounded bg-gray-50">
                    ...
                    <div className="props-check">
                        <input
                            name={props.language.id}
                            id={props.language.name}
                            type="checkbox"
                            checked={props.data[props.language.id]}
