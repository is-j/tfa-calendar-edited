            ...
            <div class="modal-body">
                <form class="needs-validation ajax" id="deleteSlotForm" novalidate>
                    ...
                    <div class="input-group mb-3" id="studentnameDelete">
                        ...
                        <input type="text" class="form-control" style="height:64px;" name="studentname" disabled>
                    ...
                    <div class="input-group" id="infoDelete">
                        <div class="input-group-prepend">
                            <span class="input-group-text">Topic needs/Help</span>
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="needs-validation ajax" id="unclaimSlotForm" novalidate>
                    ...
                    <div class="input-group mb-3" id="tutorUnclaim">
                        <div class="input-group-prepend">
                            <span class="input-group-text">tutor</span>
                        </div>
                        <input type="text" class="form-control" style="height:64px;" disabled>
                        <div class="input-group-append">
                            <span class="input-group-text"></span>
                        </div>
                    </div>
                    ...
                    <div class="input-group mb-3" id="contactUnclaim">
                        <div class="input-group-prepend">
                    ...
                    <div class="input-group" id="infoUnclaim">
                        ...
                        <textarea class="form-control" maxlength="1000" rows="3" disabled required></textarea>
                    </div>
                    <div class="input-group mt-3" id="zoomUnclaim"></div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="needs-validation ajax" id="claimSlotForm" novalidate>
                    ...
                    <div class="input-group mb-3" id="tutorClaim">
                        <div class="input-group-prepend">
                            <span class="input-group-text">tutor</span>
                        </div>
                        <input type="text" class="form-control" style="height:64px;" disabled>
                    ...
                    <div class="input-group" id="infoClaim">
                        ...
                        <textarea class="form-control" maxlength="1000" rows="3" required></textarea>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
